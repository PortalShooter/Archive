    ...
    <Header>
      <ScrollView style={{backgroundColor: '#fff', height: '100%', paddingHorizontal: 12, paddingVertical: 15,}}>
        ...
        <Text style={styles.text}>
          Максим Киктенко built the "Развитие воли и самоорганизации" app. This SERVICE is provided by Максим Киктенко and is intended for use as is.
        </Text>
        <Text style={styles.text}>This page is used to inform visitors regarding my policies with the collection, use, and disclosure of Personal Information if anyone decided to use my Service.</Text>
        ...
        <Text style={styles.text}>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at "Развитие воли и самоорганизации" unless otherwise defined in this Privacy Policy.</Text>
        <Text style={styles.textBold}>Information Collection and Use</Text>
        <Text style={styles.text}>For a better experience, while using our Service, I may require you to provide us with certain personally identifiable information, including but not limited to phone number. </Text>
        <Text style={styles.text}>The information that I request will be retained on your device and is not collected by me in any way.</Text>
        ...
        <Text style={styles.textBold}>Log Data</Text>
        ...
        <Text style={styles.textBold}>Cookies</Text>
        ...
        <Text style={styles.textBold}>Service Providers</Text>
        ...
        <Text style={styles.textBold}>Security</Text>
        ...
        <Text style={styles.textBold}>Links to Other Sites</Text>
        <Text style={styles.text}>This Service may contain links to other sites. If you click on a third-party link, you will be directed to that site. Note that these external sites are not operated by me. </Text>
        <Text style={styles.text}>Therefore, I strongly advise you to review the Privacy Policy of these websites. I have no control over and assume no responsibility for the content, privacy policies, or practices of any third-party sites or services.</Text>
        ...
        <Text style={styles.textBold}>Changes to This Privacy Policy</Text>
        ...
        <Text style={styles.text}>This policy is effective as of 2032-01-01</Text>
        <Text style={styles.textBold}>Contact Us</Text>
        <Text style={[styles.text, {marginBottom: 45}]}>If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at infosch@развитиеволи.рф.</Text>
      </ScrollView>
    </Header>
  );
};
